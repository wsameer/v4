...
const Divider: React.FC = () => <div className="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>;

export const SideBox: React.FC = () => {
    return (
        <div className="w-full sm:w-72 lg:w-80 md:fixed md:flex-shrink-0">
            <div className="p-10 md:px-4 w-full bg-gray-800 shadow-lg">
                <Avatar height="48" srcFile={IMAGE_SRC} />
